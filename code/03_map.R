...
ni_sf <- geojson_sf("spatial-data/osni_open_data_largescale_boundaries_local_government_districts_2012.geojson")
...
ggplot() +
  ...
  labs(title = "Belfast has highest percentage of people identifying as 'gay, lesbian, bisexual, or other sexual orientation'",
